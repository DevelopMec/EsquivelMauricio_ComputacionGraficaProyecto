...
// Keyframes
float posX =PosIni.x, posY = PosIni.y, posZ = PosIni.z, rotRodIzq = 0, rotRodDer = 0, rotBrIzq = 0 , rotBrDer = 0;
...
int main()
{
	...
	Model house((char*)"Models/models/houseProject.obj");
	Model bed((char*)"Models/models/cama.obj");
	Model palm((char*)"Models/models/Palm_01.obj");
	Model Cabeza((char*)"Models/Personaje/cabeza.obj");
	Model puerta((char*)"Models/models/fulldoor.obj");
	Model puertaDerecha((char*)"Models/models/rightDor.obj");
	...
	// Diffuse map
	image = stbi_load("images/down.jpg", &textureWidth, &textureHeight, &nrChannels, 0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform1f(glGetUniformLocation(lightingShader.Program, "material.shininess"), 100.0);
		...
		model = glm::translate(model, glm::vec3(posX, posY, posZ));
		model = glm::rotate(model, glm::radians(rot), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::translate(model, glm::vec3(0.0f, 2.5f, 1));
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		palm.Draw(lightingShader);
		view = camera.GetViewMatrix();
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(posX, posY, posZ));
		model = glm::rotate(model, glm::radians(rot), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::translate(model, glm::vec3(5.0f, 0.8f, 4.0f));
		model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		palm.Draw(lightingShader);
		view = camera.GetViewMatrix();
		...
		model = glm::translate(model, glm::vec3(posX, posY, posZ));
		model = glm::rotate(model, glm::radians(rot), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::translate(model, glm::vec3(5.0f, 0.8f, 6.0f));
		model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		palm.Draw(lightingShader);
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(posX, posY, posZ));
		model = glm::translate(model, glm::vec3(2.0f, 1.0f, -7.5f));
		...
		model = glm::rotate(model, glm::radians(230.0f), glm::vec3(1.7f, 2.5f, 2.5f));
		model = glm::scale(model, glm::vec3(200.0f, 400.0f, 20.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
